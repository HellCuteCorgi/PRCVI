...
"}")
        ...
        self.AddNote = QtWidgets.QPushButton(self.horizontalLayoutWidget, clicked = lambda: self.openAddNoteWindow())
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setUnderline(False)
        font.setStrikeOut(False)
        ...
        self.EditNote = QtWidgets.QPushButton(self.horizontalLayoutWidget, clicked = lambda: self.openEditNoteWindow())
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setUnderline(False)
        font.setStrikeOut(False)
